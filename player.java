...
public class Player {
    ...
    public short getFlagBag() {
        if (this.iDMark.isHoldBlackBall()) {
            return 31;
        } else if (this.iDMark.isHoldNamecBall()) {
            return 30;
        }
...
//        return -1;
    ...
    //--------------------------------------------------------------------------
    public int injured(Player plAtt, int damage, boolean piercing, boolean isMobAttack) { //pl la minh dam , plAttack la thang bi dam 
        if (!this.isDie()) {
            if (plAtt != null) {
